...
<hr>
<div>
	<h3>Empty 비교 확인</h3>	<%-- empty로 비교가 가능하다. empty로 취급이 가능하다 --%>
...
<div>
	<h3>삼항 연산자</h3>
	<p>num1 &gt; num2 ? "참" : "거짓" => ${num gt num2 ? "num1이 더크다" : "num2가 더크다" }</p>
</div>
<div>
	<h3>null 연산자</h3>
	<p>null + 10 =${null + 10 }</p>		<%-- null을 0으로 인식한다. --%>
	<p>nullStr + 10 =${nullStr + 10 }</p>	<%-- nullStr을 0으로 인식한다. --%>
	<p>param.noVar > 10 =${param.noVar >10 }</p> <%-- null을 0으로 인식한다. --%>
	<p>num3 =${num3 }</p>
