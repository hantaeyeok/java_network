...
<ul>
	...
	<li><strong>파라미터(Query) 열(두번째 중요)</strong> : <%=request.getQueryString() %></li>
	<li><strong>요청주소</strong> : <%=request.getRequestURI() %></li>
	<li><strong>요청URL</strong> : <%=request.getRequestURI() %></li>
	...
	<li><strong>현재문서의 경로(가장 중요)</strong> : <%=request.getContextPath() %></li>
	<li><strong>헤더 어셉트</strong> : <%=request.getHeader("Accept") %></li>
	<li><strong>헤더 호스트 주소</strong> : <%=request.getHeader("Host") %></li>
</ul>
<hr>
<h3>헤더 벙보 반복 출력</h3>
	<table>
		<tbody>
<%	
	Enumeration e = request.getHeaderNames();//키만 출력
